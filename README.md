...
![CI](https://github.com/YOUR_GITHUB_USERNAME/veilcred/actions/workflows/ci.yml/badge.svg)
...
```bash
# 1. Clone the repo
git clone https://github.com/YOUR_GITHUB_USERNAME/veilcred.git
cd veilcred
...
[PLACEHOLDER — add after creating the @veilcred (or similar) account and
posting the launch thread]
